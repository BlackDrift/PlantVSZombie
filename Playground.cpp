...
Playground* Playground::instantiate()
{
	...
	Plant* Plant1 = new Plant(sf::Vector2f(10.f, 50.f), &plantBehaviour, 0);
	Plant* Plant2 = new Plant(sf::Vector2f(10.f, 150.f), &plantBehaviour, 0);
	Plant* Plant3 = new Plant(sf::Vector2f(10.f, 250.f), &plantBehaviour, 0);
	Plant* Plant4 = new Plant(sf::Vector2f(10.f, 350.f), &plantBehaviour, 0);
